...
def train(
    ...
    for epoch in range(opt.niter):
        ...
        while i < num_batches:  # len(dataloader):
            ...
            while j < Diters and i < num_batches:  # len(dataloader):
                ...
                true, false = count_ground_tiles(joined_frame)
            ...
            if gen_iterations % 10000 == 0:  # was 500
                ...
                torch.save(
                    netG.state_dict(),
                    "{0}/netG_epoch_condition_012567_ground_{1}_{2}_{3}.pth".format(
    ...
    np.save('loss_data_sky_2.npy', loss_value)
...
def main():
    ...
    if opt.experiment is None:
        opt.experiment = "ground_samples_1"
